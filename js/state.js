    ...
    topics: {
        ...
        'team_battle': {
            ...
            contentHtml: `
                ...
                <p>・<b>敵チームの選出とレベル</b>: 敵チームも味方と同様に<b>合計コスト10以下</b>の公平ルールで選出されます。出現レベルはプレイヤー出撃チームの<b>最高レベル重視加重平均（80%/15%/5%）</b>に基づいて、Stage 1: 0.8倍 / Stage 2: 1.0倍 / Stage 3: 1.2倍 ＋ レアリティ微補正（Lv.1〜30）で動的にスケーリングされます。<br>
                ・<b>被ダメージ</b>: 出題後<b>2秒間はスリップダメージ無効の安全時間</b>です。2秒経過後より1秒ごとに敵攻撃力の<b>0.2倍スリップダメージ</b>、時間切れや不正解で<b>1.0倍ペナルティダメージ</b>（スリップ5秒分相当）を受けます。敵からの攻撃にも属性相性補正（敵有利1.5倍 / 敵不利0.5倍軽減）が乗るため、不利な時は即座に有利な控えキャラへ交代しましょう！<br>
