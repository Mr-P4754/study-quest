    ...
    topics: {
        ...
        'team_battle': {
            ...
            contentHtml: `
                ...
                ・<b>被ダメージ</b>: 1秒ごとに敵攻撃力の<b>0.4倍スリップダメージ</b>、時間切れや不正解で<b>1.0倍ペナルティダメージ</b>（スリップ2.5秒分相当）を受けます。敵からの攻撃にも属性相性補正（敵有利1.5倍 / 敵不利0.5倍軽減）が乗るため、不利な時は即座に有利な控えキャラへ交代しましょう！<br>
