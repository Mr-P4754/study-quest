...
export const GUIDE_DATA = {
    ...
    topics: {
        ...
        'team_battle': {
            ...
            title: 'チームバトルクエスト',
            icon: '⚔️',
            summary: '3体交代制のリアルタイム高速バトル！属性相性で敵を制覇！',
            contentHtml: `
                <h4>① 操作手順</h4>
                <p>1. タイトル画面から<b>「✨ スペシャルクエスト」→「⚔️ チームバトル」</b>を選択します。<br>
                2. <b>「パーティー編成」</b>を開き、手持ちキャラから<b>前衛1体・後衛2体（計3体）</b>を編成して決定します。<br>
                ...
                ・<b>攻撃時</b>: 有利属性なら<b>最大1.5倍</b>の弱点特効ダメージ！<br>
                ・<b>防御時</b>: 耐性属性なら敵からのスリップダメージやペナルティを<b>0.5倍（半減）</b>に抑制！<br>
                ・<b>ALL属性</b>: 攻撃時は1.25倍保証、防御時は0.75倍に被ダメージを抑制します。<br>
                ・前衛カードのバッジに「相性:○ ⚔×1.5/🛡×0.5」のように現在の攻防補正が表示されます。</p>

                <h4>④ ペナルティと撃破報酬</h4>
                <p>・<b>時間切れまたは不正解</b>で敵から<b>10倍ペナルティダメージ</b>を受けます。不利な時は即座に有利な控えキャラへ交代しましょう！<br>
                ・全3ステージ制覇で、<b>倒した敵キャラクターを直接獲得</b>＆大量EXPを入手できます！</p>
            `
        },
        'rogue': {
            categoryId: 'special',
